    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black text-zinc-100">
        <div className="text-center">
          <Cpu className="animate-spin mx-auto mb-4" size={48} />
          <p className="text-sm text-zinc-500">Initializing Evolution Engine...</p>
        </div>
      </div>
    );
  }
